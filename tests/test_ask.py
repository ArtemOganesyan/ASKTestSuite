...
class TestE2E:
    ...
    def test_e2e_student_regi_activ_sign_in(self):
        # test data will we used to create new student user, email is randomly generated for test re-usability
        test_data = {
            "email": f"{random.randint(10000000,20000000)}@gmail.com",
            "password": "011235813",
            "name": "Ivan",
            "group": "API_Test"
        }
